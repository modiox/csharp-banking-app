...
const customer4 = new Customer("Moe", 4);
...
westBranch.addCustomer(westBranch, customer4);

arizonaBank.addCustomerTransaction(westBranch, customer1.getId, 3000);
arizonaBank.addCustomerTransaction(westBranch, customer1.getId, 2000);
arizonaBank.addCustomerTransaction(westBranch, customer2.getId, 3000);
westBranch.addCustomerTransaction(westBranch, customer4.getId, 5000);

customer1.addTransactions(-1000);
customer4.addTransactions(400);
console.log(customer1.getBalance());
console.log(customer4.getBalance());
